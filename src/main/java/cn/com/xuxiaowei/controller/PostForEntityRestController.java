...
public class PostForEntityRestController {
    ...
    public ResponseEntity<String> postForEntity4(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        ...
        // 使用指定实体类解析返回结果
        ResponseEntity<String> forEntity = restTemplate.postForEntity(parameterUrl, null, String.class, uriVariables);
